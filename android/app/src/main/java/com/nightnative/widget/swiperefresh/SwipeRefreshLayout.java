...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent,
    ...
    private float mInitialTargetOffset;
...
//        ValueAnimator valueAnimator = ValueAnimator.ofFloat(0).setDuration(SCALE_DOWN_DURATION);
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                ...
                mInitialTargetOffset = mTarget.getTranslationY();
//                Log.i("xxx ddddddd", "" + mInitialDownY + " , " + mInitialTargetOffset);
...
//                    Log.i("xxx ddddddd22", "" + mInitialDownY + " , " + mInitialMotionY);
...
//                startProgressAlphaMaxAnimation();
    ...
    private void finishSpinner(float overscrollTop) {
        if (overscrollTop > mTotalDragDistance) {
            ...
            ObjectAnimator animator = ObjectAnimator.ofFloat(mTarget, "translationY", mTotalDragDistance)
                    .setDuration(SCALE_DOWN_DURATION);
