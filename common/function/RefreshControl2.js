 ...
 */
const RefreshControl2 = React.createClass({
  statics: {
  ...
  propTypes: {
    ...
    /**
     * Size of the refresh indicator, see RefreshControl2.SIZE.
     * @platform android
     */
...
//   _nativeRef: (null: any),
  ...
  componentDidUpdate(prevProps) {
    // RefreshControl2 is a controlled component so if the native refreshing
...
if (Platform.OS === 'ios') {
  ...
  var NativeRefreshControl2 = requireNativeComponent(
    'AndroidSwipeRefreshLayout2',
    RefreshControl2
  );
}

export default RefreshControl2